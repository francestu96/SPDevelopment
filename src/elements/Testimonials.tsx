...
export default function Testimonials() {
    return (
        <Container maxW={'7xl'} py={["5", "10", "12", "20"]} px="10" gap="5">
            <Card mt="5" mb="10" boxShadow="xl" borderRadius="xl">
                <CardBody  bgColor="gray.100" borderRadius="xl">
                    <Stack gap={["2", "5", "7"]} alignItems="center" fontWeight="bold" color="black">
                        <Text fontSize={["xs", "sm", "md", "xl", "2xl"]}>Con Noi</Text>
                        <HStack w="100%" justifyContent="space-around">
                            <Image src="/demo.ico" alt="demo" boxSize={["50px", "70px", "90px"]}/>
                            <Image src="/casasavino.ico" alt="casasavino" boxSize={["50px", "70px", "90px"]}/>
                            <Image src="/chat.png" alt="chat" boxSize={["50px", "70px", "90px"]}/>
                        </HStack>
                        <Text fontSize={["xl", "2xl", "3xl"]}>+30% richieste in 90 giorni</Text>
                    </Stack>
                </CardBody>
            </Card>
            <Swiper style={{ paddingBottom: "30px" }} modules={[Autoplay, Pagination]} spaceBetween={30} slidesPerView={1} pagination={{ clickable: true }} autoplay={{ delay: 40000 }} loop breakpoints={{ 768: { slidesPerView: 2 }, 1024: { slidesPerView: 3 } }}>
                <SwiperSlide>
                    <Stack bgColor="gray.100" borderRadius="xl" p={["5", "7", "10"]} gap="2">
                        <HStack w="100%" gap="5">
                            <Avatar src={"/alessio_rossi.jpg"} />
                            <Heading as={'h3'} fontSize={["sm", "md", "lg", "xl"]}>Servizio Impeccabile!</Heading>
                        </HStack>
                ...
                <SwiperSlide>
                    <Stack bgColor="gray.100" borderRadius="xl" p={["5", "7", "10"]} gap="2">
                        <HStack w="100%" gap="5">
                            ...
                            <Heading as={'h3'} fontSize={["sm", "md", "lg", "xl"]}>Professionisti Affidabili</Heading>
                        </HStack>
                        <Text textAlign="center" fontSize={["lg", "xl"]}>
                ...
                <SwiperSlide>
                    <Stack bgColor="gray.100" borderRadius="xl" p={["5", "7", "10"]} gap="2">
                        <HStack w="100%" gap="5">
                            ...
                            <Heading as={'h3'} fontSize={["sm", "md", "lg", "xl"]}>Risultati Eccezionali</Heading>
                        </HStack>
                        <Text textAlign="center" fontSize={["lg", "xl"]}>
